...
2026-05-27; morning pipeline YAML triggered this morning, but very very late.  the job is scheduled for about 4:13AM, offset from 4:00AM exactly so it doesn't get queued in a long list due to all the other triggers Github users use at 4:00AM exactly...  but it seems the offset isn't quite as effective as i'd hope.  YAML file scheduled for 4:13AM but it didn't run until about 7:50AM...  almost 4 hours late.  hmmmm...  that's pretty late...  looking into way to tighten this up.  will also start investigating SQL databases today.
