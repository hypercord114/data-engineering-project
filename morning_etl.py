    ...
    try:
        connection.execute("""
            CREATE TABLE IF NOT EXISTS daily_shift_forecasts (
                ...
                average_wind_direction_deg DOUBLE,
                average_temperature_f DOUBLE,
                average_relative_humidity DOUBLE,
                upwind_compass_direction VARCHAR,
                downwind_compass_direction VARCHAR,
        ...
        connection.execute("""
            INSERT OR REPLACE INTO daily_shift_forecasts (
                forecast_date, average_wind_direction_deg, average_temperature_f, 
                average_relative_humidity, upwind_compass_direction, downwind_compass_direction
            ) VALUES (?, ?, ?, ?, ?, ?);
